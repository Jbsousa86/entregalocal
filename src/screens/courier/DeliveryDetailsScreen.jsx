        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', gap: '16px', position: 'relative', zIndex: 1 }}>
            ...
            <div>
              ...
              {delivery.customerPhone && <div style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: '4px', display: 'flex', alignItems: 'center', gap: '4px' }}><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg> {delivery.customerPhone}</div>}
            ...
            <div style={{ maxHeight: '240px', overflow: 'auto', marginBottom: '16px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '8px 0', borderBottom: '1px solid var(--border)' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  {delivery.customerPhone && <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>Tel: {delivery.customerPhone}</div>}
              ...
              {otherDeliveries.map((d) => (
                <div key={d.id} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '8px 0', borderBottom: '1px solid var(--border)' }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    {d.customerPhone && <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>Tel: {d.customerPhone}</div>}
